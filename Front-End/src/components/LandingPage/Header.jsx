          ...
          {isAuth && isPending ? (
            ...
            <>
              ...
              <div className="flex w-full items-center justify-center">
                <div className="h-10 w-32 animate-pulse rounded-full bg-main-50/30"></div>
              </div>
            </>
          ) : isAuth && user ? (
            ...
            <>
              ...
              <div className="flex w-full items-center justify-center">
                ...
                >
                  <button
                    className="cursor-pointer rounded-full bg-main-50 px-4 py-2 text-base font-semibold text-main-600 transition-all"
                    onClick={toggleMenu}
                  >
                    {user.role === "worker"
                      ? "Worker Dashboard"
