    ...
    <div className="mb-8 grid grid-cols-1 gap-6 sm:grid-cols-2 xl:grid-cols-4">
      {stats.map((stat, index) => (
        <motion.div
          ...
          className={`group relative overflow-hidden rounded-2xl ${stat.bgColor} p-6 shadow-lg backdrop-blur-sm transition-all duration-300 hover:shadow-xl hover:-translate-y-1 border border-white/20`}
        >
          ...
          <div className="relative z-10">
            <div className="mb-4 flex items-center justify-between">
              <h3
                className={`text-sm font-semibold ${stat.textColor} tracking-wide uppercase`}
              >
                {stat.title}
              </h3>
              <div
