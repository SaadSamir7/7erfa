    ...
    return (
        ...
        >
            ...
            <div className="relative z-20 m-0 max-w-[900px] animate-[fade-in_1.5s_ease-out,float_6s_infinite] ease-in-out">
                <h2 className="mb-8 animate-[slide-in-top_1s_ease-out_both,glow_3s_infinite] bg-gradient-to-br from-white to-main-50 bg-clip-text font-brand text-3xl uppercase tracking-wide ease-in-out lg:text-5xl">
                    About Us
                </h2>
                <p className="mb-10 animate-[slide-in-left_1.5s_ease-out_both] text-base font-light text-main-50 md:text-lg">
                    At{' '}
                    <span className="relative inline-block animate-pop font-semibold text-white transition hover:scale-110">
                        7erfa
                    </span>{' '}
