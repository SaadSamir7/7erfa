    ...
    return (
        ...
        >
            ...
            <div className="absolute inset-0 overflow-hidden">
                <div className="absolute right-20 top-20 h-72 w-72 rounded-full bg-main-500/10 blur-3xl"></div>
            ...
            <div className="relative z-10 mx-auto max-w-6xl px-6 text-center text-white">
                ...
                <p className="mx-auto mb-12 max-w-3xl text-lg leading-relaxed text-gray-300 md:text-xl">
                    Professional services delivered with excellence. Find
                    verified workers, book appointments instantly, and get
